...
<div class="people-form">
    ...
    <?= $form->field($model, 'edu_lvl_id')->textInput() ?>

    <?= $form->field($model, 'edu_spec_id')->textInput() ?>

    <?= $form->field($model, 'listener_id')->textInput() ?>

    <?= $form->field($model, 'sot')->textInput(['maxlength' => true]) ?>
